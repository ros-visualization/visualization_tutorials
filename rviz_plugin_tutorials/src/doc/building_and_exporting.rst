...
this case, rviz_common), it needs a "plugin_description.xml" file.  This file
can be named anything you like, as it is specified in the plugin
package's "CMakeLists.txt" file like so:
...
librviz_plugin_tutorials (the ".so" ending is appended by
